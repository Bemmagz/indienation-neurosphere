...
echo "💰 ASSET: 100T ENPE | 1% LUV Reward"
echo "================================================="
echo "Pantau aktivitas (ISIIIIII): tail -f $LOG_FLASK"
